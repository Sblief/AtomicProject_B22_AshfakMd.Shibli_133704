                ...
                foreach ($list as $hobbies){
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="edit.php?id=<?php echo $hobbies->ID ?>&bringBackPage=<?php echo $pageNumber ?>" ><button type="button" class="btn btn-info">Edit</button></a>
                            <a href="delete.php?id=<?php echo $hobbies->ID ?>&bringBackPage=<?php echo $pageNumberBack ?>" ><button type="button" class="btn btn-danger" onclick="return confirm('Are you sure you want to delete this item?');">Delete</button>
                                <a href="trash.php?id=<?php echo $hobbies->ID ?>&bringBackPage=<?php echo $pageNumberBack ?>" ><button type="button" class="btn btn-warning">Trash</button>
                                    <a href="mailformatter.php?id=<?php echo $hobbies->ID ?>"  ><button type="button" class="btn btn-success">Send Item to Friend</button>
