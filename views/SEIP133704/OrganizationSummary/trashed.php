                    ...
                    foreach ($list as $items){
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="delete.php?id=<?php echo $items->ID ?>" ><button type="button" class="btn btn-danger" onclick="return confirm('Are you sure you want to delete these items?');">Delete</button>
