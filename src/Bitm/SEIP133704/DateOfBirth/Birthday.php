<?php
namespace App\Bitm\SEIP133704\DateOfBirth;
...
class Birthday
{
    ...
    public $tableColumn3 = "date_of_birth";
    ...
    public function store()
    {
        ...
        $queryInsert = "INSERT INTO `".$this->dbName."`.`".$this->tableName."` ( `".$this->tableColumn2."`,`".$this->tableColumn3."`) VALUES ( '".$this->name."','".$this->birthday."')";
    ...
    {
        $query="UPDATE `".$this->dbName."`.`".$this->tableName."` SET `".$this->tableColumn2."` = '".$this->name."',`".$this->tableColumn3."` = '".$this->birthday."' WHERE `".$this->tableName."`.`".$this->tableColumn1."` = ".$this->id;
